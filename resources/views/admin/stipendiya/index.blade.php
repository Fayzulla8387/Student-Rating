...
@section('content')
    <div class="row">
        ...
        <div class="col">
            <div class="card">
                @include("admin.stipendiya.create")
                <div class="card-body">
                        ...
                        @foreach($stipendiyas as $firm)
                            <tr>
                                ...
                                <td class="d-flex">
                                    ...
                                    <form action="{{route('stipendiya.destroy', $firm->id)}}" method="post">
                                        @method('DELETE')
                                        @csrf
